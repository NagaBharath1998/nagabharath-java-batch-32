...
public class CSVReader {
    public static void main(String[] args) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("/Users/nagabharathchintakunta/Desktop/CIS Tech/nagabharath-java-batch-32/nagabharath-java-batch-32/Java project/src/june7/Mockdata.csv"))) {
            br.readLine();
            String line;
